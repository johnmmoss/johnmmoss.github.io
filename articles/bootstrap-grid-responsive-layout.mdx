...
![Three Column Layout](../assets/images/bootstrap-grid-responsive-layout/three-column-layout.png)
...
* When the screen goes above 576px it becomes a small screen and the top row stays but the bottom two rows join into a single row equally spaced apart:
  ...
  ![Responsive Layout Small Screen](../assets/images/bootstrap-grid-responsive-layout/responsive-layout-small.png)

* When the screen goes above &ge;992px the screen is now large and the three rows become three equally spaced columns:
  
  ![Responsive Layout Large Screen](../assets/images/bootstrap-grid-responsive-layout/responsive-layout-large.png)
