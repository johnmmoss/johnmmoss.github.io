...
<div class="list-group">
    ...
    <div id="countries" class="list-group collapse">
        ...
        <div id="countries-0" class="list-group collapse">
            <a class="list-group-item" data-bs-toggle="collapse" href="#countries-0-counties-0">
                Yorkshire
            </a>
...
<div class="list-group">
    ...
    <div id="demo1-countries" class="list-group collapse">
        <a class="list-group-item" data-bs-toggle="collapse" href="#demo1-countries-0">
            England
        </a>
        <div id="demo1-countries-0" class="list-group collapse">
            <a class="list-group-item" data-bs-toggle="collapse" href="#demo1-countries-0-counties-0">
                Yorkshire
            </a>
...
```html
<a class="list-group-item collapse-indicator collapse-indicator-pos-1 collapsed" 
...
<div class="tree-view list-group">
    ...
    <div id="countries" class="list-group collapse">
        <a class="list-group-item collapse-indicator collapse-indicator-pos-1  collapsed" data-bs-toggle="collapse" href="#countries-0">
            England
        </a>
        <div id="countries-0" class="list-group collapse">
            <a class="list-group-item collapse-indicator collapse-indicator-pos-2 collapsed" data-bs-toggle="collapse" href="#countries-0-counties-0">
                Yorkshire
            </a>
            <div id="countries-0-counties-0" class="list-group collapse">
                <a class="list-group-item">
            ...
            <a class="list-group-item collapse-indicator collapse-indicator-pos-2 collapsed" data-bs-toggle="collapse" href="#countries-0-counties-1">
                Lancashire
            </a>
            ...
            <a class="list-group-item collapse-indicator collapse-indicator-pos-2 collapsed" data-bs-toggle="collapse" href="#countries-0-counties-2">
                Lincolnshire
            </a>
        ...
        <a class="list-group-item collapse-indicator collapse-indicator-pos-1 collapsed" data-bs-toggle="collapse">
            Scotland
        </a>
        <a class="list-group-item collapse-indicator collapse-indicator-pos-1 collapsed" data-bs-toggle="collapse">
            Wales
...
![Sample Data Driven Treeview](../assets/images/bootstrap-treeview-with-collapse/data-driven-example-screenshot.png)
...
$(document).ready(function () {
	...
	$(".city").click(function () { 
		...
		$("#map").attr('src', `https://www.google.com/maps/embed/v1/place?key=API_KEY&zoom=8&q=${city}`);
		$("#title").text(city);
...
![Demo Application Screenshot](../assets/images/bootstrap-treeview-with-collapse/demo-treeview-with-googlemaps-screenshot.png)
