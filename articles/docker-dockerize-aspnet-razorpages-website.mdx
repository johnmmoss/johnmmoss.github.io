...
![Restore/Build/Run Screenshot](../assets/images/docker-dockerize-aspnet-razorpages-website/restore-build-run-native-screenshot.png)
...
![Docker Image Screenshot](../assets/images/docker-dockerize-aspnet-razorpages-website/docker-images-screenshot.png)
...
To fix this issue we add a file at the root of the web project called ***runtimeconfig.template.json*** and add the json below. For more information review the related [github issue](https://github.com/dotnet/core/issues/2186#issuecomment-472629489):
...
![Docker musl Image Screenshot](../assets/images/docker-dockerize-aspnet-razorpages-website/docker-images-musl-screenshot.png)
