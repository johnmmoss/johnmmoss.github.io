...
tags: ["SQL Server Profiler", "Entity Framework Core"]
---
...
![](./ms-sql-server-profiler-entity-framework-image-01.png)

## Configuring Events

Select the Events Selection tab and then check Show all events and Show all columns:

![](./ms-sql-server-profiler-entity-framework-image-02.png)
...
![](./ms-sql-server-profiler-entity-framework-image-03.png)
...
![](./ms-sql-server-profiler-entity-framework-image-04.png)
