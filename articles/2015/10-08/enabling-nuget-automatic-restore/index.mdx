...
You also need to remove the _\<RestorePackages\>true\</RestorePackages\>_ line from the relevant property group. Source: [Migrating MSBuild-Integrated solutions to use Automatic Package Restore](https://docs.nuget.org/consume/package-restore/migrating-to-automatic-package-restore)
