...
date: "2022-06-06"
slug: "keycloak-setup-for-local-dev"
tags: ["Keycloak", "Docker", "OpenID Connect", "OAuth2"]
---
...
![Keycloak Homepage](./keycloak-home-screen.png)
...
![Keycloak add client](./keycloak-add-client.png)
...
![Keycloak client settings](./keycloak-update-client-confidential.png)

On clicking Save a new tab will appear called "Credentials":

![Keycloak client credentials](./keycloak-client-credentials.png)
...
![Postman token request](./keycloak-postman-token-request.png)
...
![Decoded token](./image-token-request-jwt.png)
...
![Keycloak role mapper](./keycloak-show-relamroles-mapper.png)
...
![Decoded token with roles](./image-token-request-jwt-mapped-roles.png)
